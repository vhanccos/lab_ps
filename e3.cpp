...
void listarClientesMorosos(const std::vector<Cliente>& clientes) {
    std::cout << "Clientes en estado moroso:" << std::endl;
    std::cout << "-----------------------------" << std::endl;
...
void listarClientesPagadosConFacturaMayor(const std::vector<Cliente>& clientes, double cantidad) {
    std::cout << "Clientes en estado pagado con factura mayor a $" << cantidad << ":" << std::endl;
    std::cout << "-----------------------------" << std::endl;
    for (const auto& cliente : clientes) {
        double total = cliente.unidadesSolicitadas * cliente.precioPorUnidad;
        if (cliente.estado == PAGADO && total > cantidad) {
            mostrarFactura(cliente);
        }
    }
}
...
int main() {
    ...
    double cantidad;
    std::cout << "Ingrese la cantidad minima para listar clientes pagados: ";
    std::cin >> cantidad;

    listarClientesPagadosConFacturaMayor(clientes, cantidad);
